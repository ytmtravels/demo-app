...
function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const existUser = await fetch("api/userExists", {
        method: "POST",
        headers: {
  ...
  return (
    <div className="flex  items-center justify-center bg-darkGray md:justify-start md:bg-login-gradient md:pl-40">
      <div className="flex w-[360px] flex-col items-center rounded-[22px] bg-darkGreen  p-5 shadow-login md:m-5 md:w-[440px] md:rounded-[32px]  md:bg-white/10 md:px-10 md:pb-10">
        ...
        <div className="flex w-full flex-col gap-6">
          ...
          <p className="text-sm capitalize text-white">
            By Registering In, you'll be agreeing to our{" "}
